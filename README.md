...
A repository of plugins and software that can be used to control industrial robots with Grasshopper in Rhinoceros3D.
...
|[Robot Components](#RobotComp)| **Free**  (open source)                        |:x:                                                                            |:white_check_mark:|:x:               |:x:                                                   |Win                                                          |[github](https://github.com/EDEK-UniKassel/RobotComponents)<br> [Food4Rhino](https://www.food4rhino.com/app/robot-components#) <br> [Documentation](https://robotcomponents.github.io/RobotComponents-Documentation/) <br> [github-organisation](https://github.com/RobotComponents) |
